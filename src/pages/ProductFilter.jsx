            ...
            <div className="lg:w-9/12">
              ...
              <div className="flex flex-row justify-between items-center p-2 mb-5">
                <div className="flex flex-wrap gap-3">
                  <div>
                    <div className="flex justify-center items-center gap-1 p-1 border border-gray-400 rounded-md">
                      <span>Apple</span>{" "}
                ...
                >
                  ...
                  New
                    ...
                    <div>
                      ...
                      <span className="lg:text-2xl text-red-500">
                        Ks 450,000
                      </span>
              ...
              <div className="flex justify-end my-5">
                <div className="flex flex-row justify-center items-center gap-2">
                  <div>
                    <span className="p-1 cursor-pointer text-gray-500 border-2">
                      Show more
                    </span>
                  </div>
