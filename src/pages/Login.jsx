  ...
  return <div className="max-w-screen-xl lg:h-screen flex justify-center mx-auto lg:px-0 px-2 overflow-hidden">
      <div className="lg:grid grid-cols-2 gap-3 my-10 w-full">
        <div className="bg-green-300 p-5 rounded-md">
          ...
          <div>
            {activeTab === "login" && <div id="tabs-login" role="tabpanel">
                {/* Login Form */}
                <form action="">
                  <div className="flex flex-col gap-1 mb-3">
                    ...
                    <div className="flex items-center relative">
                      <input type="text" id="email" className="rounded-none rounded-e-lg p-2 bg-gray-50 border border-gray-300 text-gray-900 focus:ring-blue-500 block flex-1 min-w-0 w-full focus:outline-none" placeholder="Email" />
                  ...
                  <div>
                    <label htmlFor="otp" className="block mt-2 tex-sm font-medium">
                    ...
                    <div className="flex">
                      ...
                      <input type="text" id="otp" className="rounded-none p-2 rounded-e-lg bg-gray-50 border border-gray-300 text-gray-900 focus:ring-blue-500 block flex-1 min-w-0 w-full text-sm focus:outline-none" placeholder="" />
                    </div>
                  </div>
                  <div className="flex items-center gap-2 my-2">
                    <input type="checkbox" className="w-5 h-5 border border-gray-300 rounded bg-gray-50 focus:ring-3 focus:ring-blue-300" id="check" />
                    <label htmlFor="check" className="text-sm">
                      Join our mailing list: Get updates, Discount, Hot new items, Gift coupon and more.
                    </label>
                  </div>
                  <div className="text-center mt-3">
                    <button type="button" className="bg-blue-500 focus:bg-blue-400 rounded-md p-2 text-white">
                      Login
                    </button>
                  </div>
                  <div className="my-5">
                    ...
                    <div className="flex justify-between items-center">
                      <div className="flex items-center my-3 gap-2">
                        <div className="w-7">
                          <img src={Google} alt="google" className="object-cover" />
                        </div>
                        <div className="w-7">
                          <img src={Facebook} alt="facebook" className="objective-cover" />
                        </div>
                        <div className="w-8">
                          <img src={Apple} alt="apple" className="object-cover" />
                        </div>
                        <div className="w-7">
                          <img src={PayPal} alt="paypal" className="object-cover" />
                        </div>
                      </div>
                      <div>
            ...
            {activeTab === "register" && <div id="tabs-register" role="tabpanel">
                {/* Register Form */}
                <form action="">
                  <div className="flex flex-col gap-1 mb-3">
                  ...
                  <div className="my-5">
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <div>
                        <Link to="#!" className="font-medium" onClick={() => handleTabClick("login")}>
        ...
        <div className="lg:px-5 px-2 lg:mt-0 mt-10">
          ...
          <div className="mt-5">
            <ul>
              ...
              <li className="flex items-center gap-2 py-2 font-medium">
                <FaCheckCircle className="text-green-500" /> Delivering in 200 Cities
              </li>
              <li className="flex items-center gap-2 py-2 font-medium">
                <FaCheckCircle className="text-green-500" /> Over 1500 Best Reviews
              </li>
              <li className="flex items-center gap-2 py-2 font-medium">
                <FaCheckCircle className="text-green-500" /> Super Fast Delivering
              </li>
              <li className="flex items-center gap-2 py-2 font-medium">
                <FaCheckCircle className="text-green-500" /> Fast and Secure Services
              </li>
              <li className="flex items-center gap-2 py-2 font-medium">
                <FaCheckCircle className="text-green-500" /> Best Service Award in 2022
              </li>
            </ul>
          </div>
