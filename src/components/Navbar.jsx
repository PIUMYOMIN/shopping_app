  ...
  return (
    <nav className="bg-blue-500">
      <div className="max-w-screen-xl lg:flex items-center justify-between mx-auto p-4">
        ...
        <div
          className={`md:block md:w-full z-50 ${toggle
        ...
        >
          <ul className="flex flex-col lg:justify-center lg:items-center font-medium p-4 md:p-0 mt-4 border-gray-100 rounded-lg lg:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0">
            ...
            <li>
              <div
                className="relative block lg:border-none border-b lg:py-2 py-4 px-3 text-white lg:flex items-center md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse"
                onMouseEnter={handleMouseEnter}
                onMouseLeave={handleMouseLeave}
              >
                <button
                  type="button"
                  className="flex rounded-full relative"
                  id="user-menu-button"
                ...
                <div
                  className={`z-50 lg:w-auto w-full text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-700 ${dropdownVisible
                    ? "block"
                    : "hidden"} lg:absolute left-1/2 lg:transform lg:-translate-x-1/2 top-full`}
                  id="user-dropdown"
                >
